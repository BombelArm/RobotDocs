...
\begin{frame}{Proces budowy - człon pierwszy }
	\begin{figure}%
		\centering
		\subfloat[Przed złożeniem]{{\includegraphics[width=.4\textwidth]{img/czlon1_1.jpg} }}%
		\qquad
		\subfloat[Efekt końcowy]{{\includegraphics[width=.4\textwidth]{img/czlon1_2.jpg} }}%
...
\begin{figure}%
	\centering
	\subfloat[Przed złożeniem]{{\includegraphics[width=.4\textwidth]{img/czlon2_1.jpg} }}%
	\qquad
	\subfloat[Efekt końcowy]{{\includegraphics[width=.4\textwidth]{img/czlon2_2.jpg} }}%
...
\begin{figure}%
	\centering
	\subfloat[Przed złożeniem]{{\includegraphics[width=.4\textwidth]{img/czlon3_1.jpg} }}%
	\qquad
	\subfloat[Efekt końcowy]{{\includegraphics[width=.4\textwidth]{img/czlon3_2.jpg} }}%
...
\begin{frame}{Elektronika - sterownik silników}
	...
	\begin{figure}%
		\centering
		\subfloat[Toshiba TB6560AHQ]{{\includegraphics[width=.6\textwidth]{img/stepper_driver.jpg} }}%
		\qquad
		\subfloat[ST L6470 \\ Źródło: www.st.com]{{\includegraphics[width=.25\textwidth]{img/x-nucleo-ihm02a1.jpg} }}%
